	...
	public Vector<Mp3> gerarLista(){
		...
		for (int i = 0; i < arquivos.length; i++){
			...
			try {
				...
				temp.setPath(arquivos[i].getAbsolutePath());
				...
				gerarLista(arquivos[i]);
			}
		}
		return lista;
	}

	public Vector<Mp3> gerarLista(File diretorio) {
		File arquivos[] = diretorio.listFiles();
		Mp3 temp;
		long microseconds;
		String time;
